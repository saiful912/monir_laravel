        ...
        <div class="card-body">
            <form method="POST" action="{{ route('user.profile.update') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="username" type="text" class="form-control @error('last_name') is-invalid @enderror"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="phone_no" type="text" class="form-control @error('phone_no') is-invalid @enderror"
                               name="phone_no" value="{{$user->phone_no }}" autocomplete="phone_no" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="street_address" type="text"
                               class="form-control @error('phone_no') is-invalid @enderror" name="street_address"
                               value="{{$user->street_address }}"  autocomplete="street_address" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select class="form-control" name="division_id">
                            <option value="{{$user->division_id }}">Please select your division</option>
